...
const TESTIMONIALS = [
    ...
    { name: "Connor B.", meta: "Australian Homeowner", quote: "Clean, fast, no clutter. Exactly what I wanted after work.", stars: 5 },
    { name: "Liam S.", meta: "Australian Homeowner", quote: "The search filters are incredibly intuitive. Found my dream villa in days.", stars: 5 },
];
                        ...
                        <div key={i} className="w-64 shrink-0 rounded-3xl border border-line bg-paper p-5 shadow-sm">
                            <div className="mb-2 flex gap-0.5 text-secondary">
                                {Array.from({ length: 5 }).map((_, s) => (
                                    <Star key={s} size={12} fill={s < t.stars ? "currentColor" : "none"} strokeWidth={1.5} />
                                ))}
                            </div>
